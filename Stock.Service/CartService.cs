   ...
   public class CartService:ICart
    {
        ...
        public CartService(WebContext context, IUser userService)
        {
            _context = context;
            _userService = userService;
        }

        public CartService(WebContext context)
        {
            _context = context;
        }
        ...
        public async Task DeleteItemFromCarttt(Product product, string id)
        {
            var cart = GetByUserID(id);
            ...
            if (shoppingCartItem != null)
            {
                ...
                {
                    await DeleteCartItem(shoppingCartItem);
                }
            }
            _context.SaveChanges();
        }

        public int DeleteItemFromCart(Product product, string id)
        {
            var cart = GetByUserID(id);
